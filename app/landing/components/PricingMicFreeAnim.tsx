...
export interface MicAnimHandle {
  start: () => void;
  stop: () => void;
}

const PricingMicFreeAnim = forwardRef<MicAnimHandle, { className?: string }>(
  ({ className }, ref) => {
...
PricingMicFreeAnim.displayName = "PricingMicFreeAnim";
export default PricingMicFreeAnim;
